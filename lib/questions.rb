...
def select_elements_starting_with_vowel(array)
  array.select {|item| item[0,1] == 'a' || item[0,1] == 'e' || item[0,1] == 'i' || item[0,1] == 'o' || item[0,1] == 'u'}
end
...
def every_possible_pairing_of_students(array)
  array = (0...(array.size-1)).inject([]) {|pairs,x| pairs += ((x+1)...array.size).map {|y| [array[x],array[y]]}}
end
